...
class HotelFilterSearchController extends GetxController {
  ...
  void sortByForHotels(String? sortBy) async {
    double lowPrice =
        convert('USD', HotelCurrency_Controller.selectedCurrency.value, 300);
    ...
    for (var hotel in validHotels) {
      ...
      bool oneStar = (HotelaverageRating.value > 0 &&
              HotelaverageRating.value <= 1 &&
              sortBy == '1 Stars') ||
          sortBy != '1 Stars';
      bool twoStar = (HotelaverageRating.value > 1 &&
              HotelaverageRating.value <= 2 &&
              sortBy == '2 Stars') ||
          sortBy != '2 Stars';
      bool threeStar = (HotelaverageRating.value > 2 &&
              HotelaverageRating.value <= 3 &&
              sortBy == '3 Stars') ||
          sortBy != '3 Stars';
      bool fourStar = (HotelaverageRating.value > 3 &&
              HotelaverageRating.value <= 4 &&
              sortBy == '4 Stars') ||
          sortBy != '4 Stars';
      bool fiveStar = (HotelaverageRating.value > 5 &&
              HotelaverageRating.value <= 6 &&
              sortBy == '5 Stars') ||
          sortBy != '5 Stars';
      if (matchesLowestPrice &&
          matchesHighestPrice &&
          highestRating &&
          oneStar &&
          twoStar &&
